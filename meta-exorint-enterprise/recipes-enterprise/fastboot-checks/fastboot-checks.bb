...
SRC_URI += "file://fastboot-prechecks.sh file://fastboot-postchecks.sh file://rcS_fastboot file://x11-input.conf file://jmobile"
...
FILES_${PN}                    = "${sysconfdir}/init.d/jmobile"
...
do_install() {
	...
	install -m 0755 jmobile ${D}/${sysconfdir}/init.d
