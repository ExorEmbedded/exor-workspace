...
echo $PGID > /var/run/hmi-chromium.pid # save pid for termination
(
    ...
    ./start.sh $@;
    dbus-send --print-reply --system --dest=com.exor.JMLauncher '/' com.exor.JMLauncher.appFinished string:"Chromium"
...
if ( pgrep chromium-bin > /dev/null ); then
    ...
    dbus-send --print-reply --system --dest=com.exor.JMLauncher '/' com.exor.JMLauncher.appLoaded string:"Chromium"
fi
