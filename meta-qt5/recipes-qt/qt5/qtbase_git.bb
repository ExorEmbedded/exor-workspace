...
PACKAGECONFIG_X11 ?= "${@bb.utils.contains('DISTRO_FEATURES', 'x11', 'xcb xinput2 glib xkb', '', d)}"
PACKAGECONFIG_FONTS ?= ""
PACKAGECONFIG_SYSTEM ?= "jpeg libpng zlib gif fontconfig"
PACKAGECONFIG_DISTRO ?= "accessibility sql-psql sql-sqlite"
...
PACKAGECONFIG[xcb] = "-xcb -xcb-xlib -qt-xcb,-no-xcb,libxcb xcb-util-wm xcb-util-image xcb-util-keysyms xcb-util-renderutil"
...
PACKAGECONFIG[xkb] = "-xkb -qt-xkbcommon-x11,-no-xkb -no-xkbcommon,"
